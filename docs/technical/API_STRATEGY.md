...
- Laravel, Vue, and Inertia.js are the current application direction.
- No public API has been committed yet.
- Future integrations such as Planning Center should be implemented through modular connector services.
...
- Planning Center remains optional and post-MVP.

## Open Questions

- Are external integrations needed for social media, calendars, or file storage?
