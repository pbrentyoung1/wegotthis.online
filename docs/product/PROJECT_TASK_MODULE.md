...
Users should not have to understand the full data model, project structure, approval structure, or dependency graph in order to participate well. Each user should see the information relevant to their role, their current responsibility, and the next helpful action.
...
Campaigns are optional strategic context for focused communication pushes such as Easter, Christmas, VBS, capital campaigns, sermon arcs, or church-wide efforts.

Campaigns answer:

> What focused strategic effort does this work support?

Campaigns are not required project parents and should not be where normal production task work happens in MVP. Projects remain the primary operational home.
...
Tasks belong to a project and may optionally belong to a deliverable. Tasks should not attach directly to campaigns in MVP.
