...
- Should the product focus first on internal church teams, multi-campus churches, agencies serving churches, or all of these later?
- How opinionated should the platform be about church communications workflows?
- Which workflows create the clearest early value?
- How much brand governance belongs in the first usable version?
- What reporting will help churches make annual staffing, budget, and ministry planning decisions?
- How can the product stay opinionated and calm while still supporting different church workflows?

## Notes

- The product vision should remain broad enough to support future modules while keeping the MVP focused.
