...
| Strategic context model finalized | Ready | Strategic context must not be confused with operational ownership before database and UI scaffolding. | Project schema, campaign/program modeling, reporting, project brief design | `docs/product/STRATEGIC_CONTEXT_AND_GOAL_ALIGNMENT.md`; `docs/product/CAMPAIGNS.md`; `docs/product/PROJECT_MANAGEMENT.md`; `docs/decisions/PRODUCT_DECISIONS.md` | Canonical model separates Strategic Context from Operational Work. Campaigns and initiatives are optional context; Programs / Content Streams are recurring rhythms; MVP should not force every project into a campaign. |
...
| Project required fields finalized | Ready | Project creation needs a stable minimum shape before schema and UI work. | Project schema, project brief UI, request conversion | `docs/product/PROJECT_MANAGEMENT.md`; `docs/technical/DATABASE.md`; `docs/decisions/PRODUCT_DECISIONS.md` | Projects require title, owner, objective, start date, and stop date. |
| Deliverable lifecycle finalized | Ready | Deliverables are the main production and approval unit. | Approval implementation, publication flow, revision handling | `docs/product/DELIVERABLES.md`; `docs/product/TASKS.md`; `docs/decisions/WORKFLOW_DECISIONS.md` | Deliverables must belong to a project; deliverable approvals stay separate from project status. |
| Task status model finalized | Ready | Tasks need clear status transitions before the app can track work reliably. | Task schema, task UI, task workflow logic | `docs/product/TASKS.md`; `docs/product/PROJECT_MANAGEMENT.md` | Finalized with Deferred and Canceled as distinct statuses. Tasks belong to a project and may optionally belong to a deliverable. |
