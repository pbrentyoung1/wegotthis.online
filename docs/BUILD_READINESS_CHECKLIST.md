...
| Hosting.com PostgreSQL and deployment constraints confirmed | Blocked | The scaffold needs real deployment assumptions before the stack is written down. | Database setup, deployment path, environment config | `docs/technical/DEPLOYMENT.md`; `docs/resources/HOSTING_NOTES.md`; `docs/ROADMAP.md` | Final hosting/deployment constraints still need confirmation. |
