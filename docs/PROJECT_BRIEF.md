...
Summarize the project in a concise, durable form for contributors, designers, and AI assistants.
...
- Future integrations, including Planning Center, should remain optional connectors rather than MVP dependencies.
...
- What language should be used to describe the product publicly?
- Which church size or team structure is the first target user profile?
- What customer-facing promise should guide MVP prioritization?
- Which integrations should be supported after the platform is useful without them?
- How much budget and utilization data should departments see?
- What project closeout requirements are mandatory for MVP?
