    ...
    <div class="card relative">
      <div class="card-body">
        <div class="absolute end-0 top-0">
          <img :src="authImage" class="w-full opacity-70" alt="auth-card-bg" />
        </div>
        <div class="flex flex-col">
          ...
          <h4 class="mb-2 mt-5 text-lg font-bold">1. Information We Collect</h4>
          ...
          <p class="mb-4">
            ...
            <a href="mailto:privacy&#64;example.com" class="text-primary">privacy&#64;example.com</a>
            .
          </p>
