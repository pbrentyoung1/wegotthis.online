const amazon = '/images/logos/amazon.svg'
const apple = '/images/logos/apple.svg'
const starbucks = '/images/logos/starbucks.svg'
const meta = '/images/logos/meta.svg'
const spotify = '/images/logos/spotify.svg'
const google = '/images/logos/google.svg'
const airbnb = '/images/logos/airbnb.svg'
const shell = '/images/logos/shell.svg'
const walmart = '/images/logos/walmart.svg'
