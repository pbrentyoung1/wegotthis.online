...
export const categoryData: CategoryType[] = [
  { label: 'Technology', href: '', className: 'text-primary' },
  { label: 'Travel', href: '', className: 'text-success' },
  { label: 'Lifestyle', href: '', className: 'text-danger' },
  { label: 'Photography', href: '', className: 'text-info' },
]
