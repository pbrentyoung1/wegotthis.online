<template>
  <div class="card">
    <div class="card-header">
      ...
      <div class="flex flex-wrap items-center gap-3">
        ...
        <button class="btn bg-secondary text-white hover:bg-secondary-hover" type="button" data-hs-overlay="#addUserModal">Add User</button>
      </div>
    </div>
      ...
      <table class="table-hover table">
        ...
        <tbody>
          <tr v-for="(user, idx) in userData.slice(0, 8)" :key="idx">
            ...
            <td>
              <h5>
                <RouterLink to="" class="text-sm font-semibold hover:text-primary">
                  {{ user.id }}
                </RouterLink>
              </h5>
            </td>
  ...
  <div id="addUserModal" class="hs-overlay pointer-events-none fixed start-0 top-0 z-80 hidden size-full overflow-x-hidden overflow-y-auto">
        ...
        <div class="card-body overflow-y-auto">
          <div class="grid grid-cols-2 gap-base">
            ...
            <div>
              ...
              <input type="file" class="block w-full rounded border border-default-300 file:me-4 file:border-0 file:bg-default-100 file:px-3 file:py-2" />
