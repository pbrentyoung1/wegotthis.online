<template>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-base mb-base">
    <div class="border-default-300 peer-checked:border-primary relative rounded-md border p-5">
      <input class="form-radio peer absolute end-2 bottom-2 rounded-full!" type="radio" name="deli-address" id="add-home" checked />
    ...
    <div>
      <div class="border-default-300 peer-checked:border-primary relative rounded-md border p-5">
        <input class="form-radio peer absolute end-2 bottom-2 rounded-full!" type="radio" name="deli-address" id="add-office" />
  ...
  <form>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-base mb-base">
      <div>
        ...
        <input class="form-input" type="text" placeholder="Enter your first name" id="shipping-add-first-name" />
      </div>
      <div>
        <label for="shipping-add-last-name" class="form-label">Last Name</label>
        <input class="form-input" type="text" placeholder="Enter your last name" id="shipping-add-last-name" />
      </div>

      <div>
        <label for="shipping-add-email-address" class="form-label">
          Email
          <span class="text-danger">*</span>
        </label>
        <input class="form-input" type="email" placeholder="Enter your email" id="shipping-add-email-address" />
      </div>

      <div>
        <label for="shipping-add-phone" class="form-label">
          Phone
          <span class="text-danger">*</span>
        </label>
        <MaskInput v-model="phoneWithArea" mask="(##) ###-####-###" class="form-input" type="text" placeholder="(xx) xxx xxxx xxx" id="shipping-add-phone" />
      </div>

      <div class="col-span-1 md:col-span-2">
        <label for="shipping-add-address" class="form-label">
          Address
          <span class="text-danger">*</span>
        </label>
        <textarea class="form-textarea" id="shipping-add-address" rows="2" placeholder="Enter your address"></textarea>
      </div>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-base mb-base">
      <div>
        ...
        <input class="form-input" type="text" placeholder="Enter your city name" id="shipping-add-town-city" />
      </div>
      <div>
        <label for="shipping-add-state" class="form-label">State</label>
        <input class="form-input" type="text" placeholder="Enter your state" id="shipping-add-state" />
      </div>
      <div>
        <label for="shipping-add-zip-postal" class="form-label">Zip / Postal Code</label>
        <MaskInput v-model="zip" mask="#####-###" class="form-input" type="text" placeholder="Enter your zip code" id="shipping-add-zip-postal" />
      </div>
    </div>
    ...
    <div class="flex justify-end">
      <button type="button" class="btn btn-sm bg-success text-white hover:bg-success-hover">Save</button>
    </div>
  </form>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-base mb-base">
    <div class="border-default-300 rounded border p-5">
      <div class="flex gap-2">
        <input type="radio" id="shippingMethodRadio1" name="shippingOptions" class="form-radio rounded-full!" checked />
    ...
    <div class="border-default-300 rounded border p-5">
      <div class="flex gap-2">
        <input type="radio" id="shippingMethodRadio2" name="shippingOptions" class="form-radio rounded-full!" />
