<template>
  ...
  <div class="container">
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-base">
      <CardWithAction title="Default Tabs" isCollapsible>
        <p class="text-default-400 mb-4">Simple widget of tabbable panes of local content.</p>
        <div>
          <nav class="flex flex-wrap" aria-label="Tabs" role="tablist" data-hs-tab-select="#tab-select">
            <button
              type="button"
        ...
        <div class="mt-5">
          <div id="default-overview" role="tabpanel" class="hidden" aria-labelledby="overview">
          ...
          <div id="default-settings" class="hidden" role="tabpanel" aria-labelledby="settings">
      ...
      <CardWithAction title="Tabs Justified" isCollapsible>
        ...
        <div>
          <nav class="flex flex-wrap md:flex-nowrap" aria-label="Tabs" role="tablist" data-hs-tab-select="#tab-select">
            <button
              type="button"
      ...
      <CardWithAction title="Tabs Vertical Left" isCollapsible>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-base">
          ...
          <div class="md:col-span-3">
            ...
            <div id="v-pills-profile-tab" class="hidden" role="tabpanel" aria-labelledby="vertical-activity">
            ...
            <div id="v-pills-settings-tab" class="hidden" role="tabpanel" aria-labelledby="vertical-settings">
            ...
            <div id="v-pills-projects-tab" class="hidden" role="tabpanel" aria-labelledby="vertical-projects">
            ...
            <div id="v-pills-support-tab" class="hidden" role="tabpanel" aria-labelledby="vertical-support">
      ...
      <CardWithAction title="Tabs with Colored Navs" isCollapsible>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-base">
          <div class="md:col-span-3">
            ...
            <div id="v-pills-profile-right" class="hidden" role="tabpanel" aria-labelledby="right-activity">
              <p class="mb-2">Manage your personal details, change your profile photo, and update your contact information.</p>
              <ul class="mb-4 list-disc space-y-1 ps-8">
                <li>Name, Email, Phone</li>
                <li>Change Password</li>
            ...
            <div id="v-pills-settings-right" class="hidden" role="tabpanel" aria-labelledby="right-settings">
              <p class="mb-2">Customize your preferences, notification options, and privacy settings.</p>
              <ul class="mb-4 list-disc space-y-1 ps-8">
                <li>Theme selection: Light / Dark mode</li>
                <li>Email & push notification toggles</li>
            ...
            <div id="v-pills-projects-right" class="hidden" role="tabpanel" aria-labelledby="right-projects">
              <p class="mb-2">Track all your active, completed, and upcoming projects in one place.</p>
              <ul class="mb-4 list-disc space-y-1 ps-8">
                <li>Kanban board and Gantt charts</li>
                <li>Task assignments and deadlines</li>
            ...
            <div id="v-pills-support-right" class="hidden" role="tabpanel" aria-labelledby="right-support">
              <p class="mb-2">Need assistance? Access our help center or contact our support team directly.</p>
              <ul class="mb-4 list-disc space-y-1 ps-8">
                <li>Browse FAQs and tutorials</li>
                <li>Submit a support ticket</li>
      ...
      <CardWithAction title="Tabs Bordered" isCollapsible>
        ...
        <div>
          <nav class="border-default-300 flex flex-wrap border-b" aria-label="Tabs" role="tablist" data-hs-tab-select="#tab-select">
            <button
              type="button"
        ...
        <div class="mt-5">
          ...
          <div id="settings-b1" class="hidden" role="tabpanel" aria-labelledby="settings-border">
      ...
      <CardWithAction title="Bordered Tabs with Colored Border" isCollapsible>
        ...
        <div>
          <nav class="border-default-300 flex border-b" aria-label="Tabs" role="tablist" data-hs-tab-select="#tab-select">
            <button
              type="button"
              ...
              role="tab"
            >
              <Icon icon="smart-home" class="text-base" />
            ...
            <button
              ...
              role="tab"
            >
              <Icon icon="user-circle" class="text-base" />
            ...
            <button
              ...
              role="tab"
            >
              <Icon icon="settings" class="text-base" />
            ...
            <button
              ...
              role="tab"
            >
              <Icon icon="alert-octagon" class="text-base" />
        ...
        <div class="mt-5">
          ...
          <div id="settings-ib1" class="hidden" role="tabpanel" aria-labelledby="settings-icon">
      ...
      <CardWithAction title="Icons Tabs" isCollapsible>
        ...
        <div>
          <nav class="border-default-300 flex flex-wrap border-b" aria-label="Tabs" role="tablist" data-hs-tab-select="#tab-select">
            <button
              ...
              role="tab"
            >
              <Icon icon="smart-home" class="size-5.5" />
            </button>
            ...
            <button
              ...
              role="tab"
            >
              <Icon icon="user-circle" class="size-5.5" />
            </button>
            ...
            <button
              ...
              role="tab"
            >
              <Icon icon="settings" class="size-5.5" />
            </button>
            ...
            <button
              ...
              role="tab"
            >
              <Icon icon="alert-octagon" class="size-5.5" />
            </button>
          </nav>
        </div>
        ...
        <div class="mt-5">
          ...
          <div id="settings-i1" class="hidden" role="tabpanel" aria-labelledby="settings-border">
      ...
      <div class="card">
        <div class="card-header border-dashed">
          ...
          <nav class="nav-tabs" aria-label="Tabs" role="tablist" data-hs-tab-select="#tab-select">
            <button type="button" class="nav-link hs-tab-active:border-b hs-tab-active:border-primary hs-tab-active:text-primary hover:text-primary" id="summary" aria-selected="true" data-hs-tab="#home-ct" aria-controls="home-ct" role="tab">
              <Icon icon="smart-home" class="block md:hidden" />
              <div class="hidden md:block">Summary</div>
            </button>

            <button type="button" class="nav-link hs-tab-active:border-b hs-tab-active:border-primary hs-tab-active:text-primary hover:text-primary active" id="accounts" aria-selected="false" data-hs-tab="#profile-ct" aria-controls="profile-ct" role="tab">
              <Icon icon="user-circle" class="block md:hidden" />
              <div class="hidden md:block">Accounts</div>
            </button>

            <button type="button" class="nav-link hs-tab-active:border-b hs-tab-active:border-primary hs-tab-active:text-primary hover:text-primary" id="setting" aria-selected="false" data-hs-tab="#settings-ct" aria-controls="settings-ct" role="tab">
              <Icon icon="settings" class="block md:hidden" />
              <div class="hidden md:block">Settings</div>
            </button>
          </nav>
        </div>
