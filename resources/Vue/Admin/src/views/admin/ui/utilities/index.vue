  ...
  <div class="container">
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-base mb-base">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="flex flex-wrap items-center gap-3">
              <img src="/images/users/user-2.jpg" class="size-11 rounded-md" alt="rounded" />
              <img src="/images/users/user-2.jpg" class="size-11 rounded-t-md" alt="rounded" />
              <img src="/images/users/user-2.jpg" class="size-11 rounded-e-md" alt="rounded" />
              <img src="/images/users/user-2.jpg" class="size-11 rounded-b-md" alt="rounded" />
              <img src="/images/users/user-2.jpg" class="size-11 rounded-s-md" alt="rounded" />
              <img src="/images/users/user-2.jpg" class="size-11 rounded-full" alt="rounded" />
              <img src="/images/stock/small-3.jpg" class="w-20 rounded-4xl" alt="rounded-full" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="flex flex-wrap items-center gap-3">
            <img src="/images/users/user-4.jpg" class="size-11" alt="rounded" />
            <img src="/images/users/user-4.jpg" class="size-11 rounded" alt="rounded" />
            <img src="/images/users/user-4.jpg" class="size-11 rounded-md" alt="rounded" />
            <img src="/images/users/user-4.jpg" class="size-11 rounded-lg" alt="rounded" />
            <img src="/images/users/user-4.jpg" class="size-11 rounded-2xl" alt="rounded" />
            <img src="/images/users/user-4.jpg" class="size-11 rounded-full" alt="rounded" />
          </div>
        </div>
      </div>
          ...
          <div class="grid grid-cols-4 items-center gap-7.5">
            ...
            <div class="bg-default-100 h-25 overflow-visible p-5">
              <p>
                ...
                on an element with set width and height add more text dimensions
                {{ META_DATA.name }} admin dashboard template.
              </p>
            </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-base">
      <div class="card">
        ...
        <div class="card-body">
          <p class="text-default-400 mb-4">Height utility classes in Tailwind CSS provide quick control over element height using predefined values such as 25%, 50%, 75%, 100%, and auto. These utilities make it easy to build consistent and responsive layouts.</p>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <p class="text-default-400 mb-4">Object-fit utilities allow you to control how media elements like images and videos resize within their containers. You can preserve the aspect ratio, fill the container, or stretch the content based on your layout needs.</p>

          <div class="flex items-start flex-wrap gap-base text-center">
            <div>
              <img src="/images/stock/small-1.jpg" class="object-contain border border-default-200 rounded size-12 mx-auto" alt="..." />
              <p class="mt-1 mb-0">
                <code class="user-select-all">.object-contain</code>
              </p>
            </div>
            <div>
              <img src="/images/stock/small-1.jpg" class="object-cover border border-default-200 rounded size-12 mx-auto" alt="..." />
              <p class="mt-1 mb-0">
                <code class="user-select-all">.object-cover</code>
              </p>
            </div>
            <div>
              <img src="/images/stock/small-1.jpg" class="object-fill border border-default-200 rounded size-12 mx-auto" alt="..." />
              <p class="mt-1 mb-0">
                <code class="user-select-all">.object-fill</code>
              </p>
            </div>
            <div>
              <img src="/images/stock/small-1.jpg" class="object-scale-down border border-default-200 rounded size-12 mx-auto" alt="..." />
              <p class="mt-1 mb-0">
                <code class="user-select-all">.object-scale-down</code>
              </p>
            </div>
            <div>
              <img src="/images/stock/small-1.jpg" class="object-none border border-default-200 rounded size-12 mx-auto" alt="..." />
              <p class="mt-1 mb-0">
