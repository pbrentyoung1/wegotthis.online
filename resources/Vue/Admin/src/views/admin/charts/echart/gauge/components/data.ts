  ...
  series: [
    {
      ...
      axisLabel: { color: getColor('default-400'), fontSize: 12 },
      detail: {
        valueAnimation: true,
        formatter: (value) => `{value|${value}}\n{name|SCORE}`,
        rich: {
          value: { fontSize: 24, fontWeight: 'bold', lineHeight: 30, color: getColor('default-900') },
          name: { fontSize: 14, color: getColor('default-400'), padding: [8, 0, 0, 0] },
        },
      },
      data: [{ value: 50 }],
    },
  ...
  series: [
    {
      ...
      progress: {
        ...
        roundCap: true,
        clip: false,
        itemStyle: { borderWidth: 1, borderColor: getColor('default-300') },
      },
...
export function setTemperatureChartInstance(instance: ECharts) {
  ...
  series: [
    {
      ...
      axisLabel: { distance: -20, color: getColor('default-400'), fontSize: 16 },
      anchor: { show: false },
      title: { show: false },
      detail: {
        valueAnimation: true,
