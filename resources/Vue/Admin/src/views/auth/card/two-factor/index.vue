                ...
                <form action="">
                  <div class="mb-5">
                    ...
                    <div class="two-factor flex gap-2">
                      <VOtpInput v-model:value="otp" :num-inputs="6" separator=" " input-type="tel" :is-input-num="true" :should-auto-focus="true" input-classes="form-input text-center mx-1" />
                    </div>
                  </div>

                  <div>
                    <button type="submit" class="btn bg-primary w-full py-3 font-semibold text-white hover:bg-primary-hover">Confirm</button>
                  </div>
                </form>
