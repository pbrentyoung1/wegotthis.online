<template>
  <section class="bg-light bg-opacity-50 border-top border-light position-relative" id="home">
    <div class="position-absolute top-0 start-50 translate-middle-x mt-5">
      <img src="/images/bg-pattern.png" alt="bg pattern" />
    </div>
    ...
    <BContainer class="pt-5 position-relative">
      <BRow>
        <BCol lg="8" class="mx-auto text-center">
          ...
          <p class="mb-4 fs-sm text-muted lh-lg">Build powerful, modern web applications with our top-rated Admin Dashboard Template. Designed for performance, flexibility, and ease of customization, it’s the perfect solution for startups, agencies, and enterprise teams.</p>

          <div class="d-flex gap-1 gap-sm-2 flex-wrap justify-content-center">
            <Link href="/" class="btn btn-secondary py-2 fw-semibold">
              <IconifyIcon icon="tabler:basket" class="fs-xl me-2" />
              Buy Now!
            </Link>
            <Link href="https://wrapbootstrap.com/user/WebAppLayers/message" class="btn btn-light py-2 fw-semibold" target="_blank">
              <IconifyIcon icon="tabler:confetti" class="fs-xl me-2" />
              Contact Us
            </Link>
          </div>
        </BCol>
      ...
      <BRow>
        <BCol md="10" class="mx-auto position-relative">
          ...
          <img src="/images/dashboard-1.png" alt="SaaS Preview" class="rounded-top-4 shadow-lg img-fluid mt-5" />
        </BCol>
      </BRow>
    </BContainer>
  </section>
...
const avatars: string[] = ['/images/users/user-7.jpg', '/images/users/user-8.jpg', '/images/users/user-9.jpg', '/images/users/user-1.jpg', '/images/users/user-2.jpg']
</script>
