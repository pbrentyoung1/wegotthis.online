      ...
      <BRow class="align-items-center pb-5">
        <BCol lg="6" xl="5" class="py-3">
          <div class="position-relative">
            ...
            <img src="/images/chat.png" alt="Chat App" class="rounded-3 shadow-lg img-fluid mt-5 z-1 position-relative" />
        ...
        <BCol lg="5" class="ms-auto py-3">
          ...
          <p class="mb-2 lead">Fast, secure, and intuitive—our chat platform empowers teams and communities to communicate effortlessly.</p>
      ...
      <BRow class="align-items-center py-5">
        ...
        <BCol lg="6" xl="5" class="ms-auto py-5 order-1 order-lg-2">
          <div class="position-relative">
            ...
            <img src="/images/file-manager.png" class="rounded-3 shadow-lg img-fluid mt-5 z-1 position-relative" alt="File Manager" />
            <figure class="position-absolute bottom-0 end-0 me-n5 mb-n5 opacity-25">
              <svg width="120" height="120" xmlns="http://www.w3.org/2000/svg">
                <g fill="#f8ac59">
                  <circle cx="10" cy="10" r="4" />
      ...
      <BRow class="align-items-center py-5">
        <BCol lg="6" xl="5" class="py-3">
          <div class="position-relative">
            ...
            <img src="/images/team.png" class="rounded-3 shadow-lg img-fluid mt-5 z-1 position-relative" alt="Team" />
            <figure class="position-absolute bottom-0 end-0 me-n5 mb-n5 opacity-25">
              <svg width="120" height="120" xmlns="http://www.w3.org/2000/svg">
                <g fill="#ed5565">
                  <circle cx="10" cy="10" r="4" />
        ...
        <BCol lg="5" class="ms-auto py-3">
          ...
          <p class="mb-2 lead">Our smart contacts app keeps all your relationships organized and accessible across devices.</p>
