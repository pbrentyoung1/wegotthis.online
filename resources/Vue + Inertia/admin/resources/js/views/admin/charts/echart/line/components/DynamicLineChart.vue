<template>
  <BCard no-body>
    <BCardHeader>
      <BCardTitle as="h4" class="mb-0">Dynamic Line</BCardTitle>
    </BCardHeader>
    <BCardBody>
      <EChart :extensions="[LineChart, CanvasRenderer]" :getOptions="getDynamicLineChart" :style="{ height: '300px' }" />
    </BCardBody>
  </BCard>
</template>
