<template>
  ...
  <BCard no-body>
    ...
    <BCardBody>
      ...
      <Link class="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/utilities/colors/" target="_blank">
        Colors on Bootstrap
  ...
  <BRow>
    <BCol cols="12">
      <CardWithAction title="Background Colors">
  ...
  <BRow>
    <BCol cols="12">
      <CardWithAction title="Text Colors & Link Colors" class="mb-0">
        <div class="table-responsive">
          <table class="table table-bordered align-middle table-striped mb-0">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <Link href="#!" class="link-primary">Primary Link</Link>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <Link href="#!" class="link-secondary">Secondary Link</Link>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <Link href="#!" class="link-success">Success Link</Link>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <Link href="#!" class="link-info">Info Link</Link>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <Link href="#!" class="link-danger">Danger Link</Link>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <Link href="#!" class="link-warning">Warning Link</Link>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <Link href="#!" class="link-purple">Purple Link</Link>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <Link href="#!" class="link-dark">Dark Link</Link>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <Link href="#!" class="link-light bg-dark">Light Link</Link>
                </td>
              </tr>
  ...
  <BRow>
    <BCol xl="6">
      <CardWithAction title="Additive(Add) Border">
    ...
    <BCol xl="6">
      <CardWithAction title="Subtractive(Remove) Border">
  ...
  <BRow>
    <BCol xl="6">
      <CardWithAction title="Border Color">
      ...
      <CardWithAction title="Border Width Size">
        <div class="d-flex align-items-start flex-wrap gap-2">
          <div class="text-center">
      ...
      <CardWithAction title="Border Subtle Color">
        <p class="text-muted">Change the border color using utilities built on our theme colors.</p>
        <div class="d-flex align-items-start flex-wrap gap-2">
          <div class="text-center">
    ...
    <BCol xl="6">
      <CardWithAction title="Border Opacity">
