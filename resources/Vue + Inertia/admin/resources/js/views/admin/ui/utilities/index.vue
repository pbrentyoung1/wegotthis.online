<template>
  ...
  <div class="container-xxl">
    <BRow>
      <BCol cols="12">
        <CardWithAction title="Examples">
          <p class="text-muted mb-2">The utility API is a Sass-based tool to generate utility classes.</p>
          <Link class="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/utilities/background/" target="_blank">
      ...
      <BCol xl="4">
        <CardWithAction title="Color & Background" isCollapsable>
          <p class="text-muted">
      ...
      <BCol xl="4">
        <CardWithAction title="Background Opacity" isCollapsable>
          <p class="text-muted"><code>background-color</code> utilities are generated with Sass using CSS variables.</p>
      ...
      <BCol xl="4">
        <CardWithAction title="Text Opacity Color" isCollapsable>
        ...
        <CardWithAction title="Opacity">
          <p class="text-muted">
            The <code>opacity</code> property sets the opacity level for an element. The opacity level describes the transparency level, where <code>1</code> is not transparent at all, <code>.5</code> is 50% visible, and <code>0</code> is completely transparent. Set the
            <code>opacity</code> of an element using <code>.opacity-{value}</code> utilities.
          </p>
      ...
      <BCol xl="4">
        <CardWithAction title="Border Radius" isCollapsable>
          <div class="d-flex align-items-start flex-wrap gap-2">
            ...
            <img src="/images/stock/small-3.jpg" class="rounded-pill" alt="rounded-pill" width="80" />
          </div>
        </CardWithAction>

        <CardWithAction title="Pointer Events">
          <p><Link href="#" class="pe-none" tabindex="-1">This link</Link> cannot be clicked.</p>
          <p><Link href="#" class="pe-auto">This link</Link> can be clicked.</p>
        </CardWithAction>
      </BCol>

      <BCol xl="4">
        <CardWithAction title="Border Radius Size" isCollapsable>
      ...
      <BCol xl="4">
        <CardWithAction title="Text Selection" isCollapsable>
          <div card-body>
      ...
      <BCol xl="12">
        <CardWithAction title="Overflow" isCollapsable>
          <div card-body>
            ...
            <div class="d-flex flex-wrap gap-4">
              ...
              <div class="overflow-visible p-3 bg-light" style="max-width: 260px; max-height: 100px">This is an example of using <code>.overflow-visible</code> on an element with set width and height add more text dimensions Premium admin dashboard template.</div>
      ...
      <BCol xl="4">
        <CardWithAction title="Position in Arrange" isCollapsable>
          <div card-body>
      ...
      <BCol xl="4">
        <CardWithAction title="Position in Center" isCollapsable>
          <div card-body>
      ...
      <BCol xl="4">
        <CardWithAction title="Position in Axis" isCollapsable>
          <div card-body>
      ...
      <BCol xl="4">
        <CardWithAction title="Shadows" isCollapsable>
          <div card-body>
            <p class="text-muted">
              While shadows on components are disabled by default in Bootstrap and can be enabled via <code>$enable-shadows</code>, you can also quickly add or remove a shadow with our <code>box-shadow</code> utility classes. Includes support for <code>.shadow-none</code> and
      ...
      <BCol xl="4">
        <CardWithAction title="Width" isCollapsable>
          <div card-body>
            <p class="text-muted">
              Width utilities are generated from the utility API in <code>_utilities.scss</code>. Includes support for <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, and <code>auto</code> by default. Modify those values as you need to generate different
              utilities here.
            </p>
      ...
      <BCol xl="6">
        <CardWithAction title="Height" isCollapsable>
          <div card-body>
            <p class="text-muted">
              Height utilities are generated from the utility API in <code>_utilities.scss</code>. Includes support for <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, and <code>auto</code> by default. Modify those values as you need to generate different
              utilities here.
            </p>
      ...
      <BCol xl="6">
        <CardWithAction title="Object Fit" isCollapsable>
          <div card-body>
            <p class="text-muted">
              Change the value of the <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/object-fit" target="_blank"><code>object-fit</code> property</a> with our responsive <code>object-fit</code> utility classes. This property tells the content to fill the parent
              container in a variety of ways, such as preserving the aspect ratio or stretching to take up as much space as possible.
            </p>
      ...
      <BCol xl="4">
        <CardWithAction title="Z-index" isCollapsable>
          <div card-body>
            <p class="text-muted">
              Use <code>z-index</code> utilities to stack elements on top of one another. Requires a <code>position</code> value other than <code>static</code>, which can be set with custom styles or using our
