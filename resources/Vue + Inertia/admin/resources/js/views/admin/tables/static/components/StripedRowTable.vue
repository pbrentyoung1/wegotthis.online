<template>
  <BCard no-body>
    <BCardHeader class="justify-content-between">
      ...
      <Link href="https://getbootstrap.com/docs/5.3/content/tables/#striped-rows" target="_blank" class="icon-link icon-link-hover link-secondary link-underline-opacity-25 fw-semibold">
        View Docs
