<template>
  <BCard no-body>
    <BCardHeader class="justify-content-between">
      ...
      <Link href="https://getbootstrap.com/docs/5.3/content/tables/#active-tables" target="_blank" class="icon-link icon-link-hover link-secondary link-underline-opacity-25 fw-semibold">
        View Docs
          ...
          <tr v-for="(product, idx) in staticTableData.data" :key="idx" :class="idx === 0 ? 'table-active' : ''">
            ...
            <td class="text-end">
              <BDropdown end variant="link" toggle-class="drop-arrow-none fs-xxl link-reset p-0">
                ...
                <BDropdownItem href="#"> <Icon icon="edit" class="me-1" /> Edit </BDropdownItem>
                <BDropdownItem href="#" class="text-danger"> <Icon icon="trash" class="me-1" /> Delete </BDropdownItem>
              </BDropdown>
            </td>
          </tr>
        </tbody>
