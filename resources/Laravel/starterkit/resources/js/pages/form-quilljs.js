...
if (typeof Quill != "undefined") {
    ...
    const fullFormats = ["font", "bold", "italic", "underline", "strike", "color", "background", "script", "header", "blockquote", "list", "indent", "align", "link", "image", "video"]
    const simpleFormats = ["bold", "italic", "underline", "list", "link", "blockquote"]
    const richFormats = [...simpleFormats, "header"]

    // Full Snow editor (form/text-editors demo)
    ...
    // Bubble theme (form/text-editors demo)
    ...
    // Simple editor — bio, short notes (ui/forms)
    const simpleToolbar = [
    ...
    ;["bio-editor", "notes-editor"].forEach((id) => {
    ...
    // Rich editor — longer descriptive fields (ui/forms)
