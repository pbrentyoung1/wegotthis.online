              ...
              <BCol lg="6">
                <div class="card-body">
                  <div class="auth-brand text-center mb-4">
                    <AuthLogo />
                    <h4 class="fw-bold mt-4">Set a new password</h4>
                    <p class="text-muted w-lg-75 mx-auto">Choose a strong new password for your account and confirm it below.</p>
                  </div>

                  <BForm @submit.prevent="submit">
                    <BAlert v-if="form.hasErrors" variant="danger" model-value class="mb-3">
                      Please review the password reset details below.
                    </BAlert>
                    ...
                    <div class="d-grid">
                      <BButton type="submit" variant="primary" class="fw-semibold py-2" :disabled="form.processing">Update Password</BButton>
                    </div>
                  </BForm>
