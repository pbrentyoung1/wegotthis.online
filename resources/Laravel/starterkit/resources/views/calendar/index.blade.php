        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header flex flex-wrap items-center justify-between gap-3">
                    <div><h4 class="card-title">Calendar</h4><p class="text-default-400 mt-1 text-sm">See personal work or switch to a focused organization schedule.</p></div>
                ...
                <div class="card-body"><div data-events-url="{{ route("calendar.events") }}" id="schedule-calendar"></div></div>
            </div>
        </div>
