@extends("shared.base", ["title" => "Datatables basic"])
...
@section("content")
    <div class="wrapper">
        @include("shared.partials.topbar", ["subtitle" => "Tables", "title" => "Basic"]) @include("shared.partials.sidenav")
                                ...
                                <div aria-labelledby="hs-dismiss-button-label" class="hs-removing:translate-x-5 hs-removing:opacity-0 transition duration-300 bg-warning/10 text-warning text-sm rounded-lg py-3 px-4 mb-5" id="table-alert" role="alert" tabindex="-1">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ps-3 ms-auto">
                                            <button class="-mx-1.5" data-hs-remove-element="#table-alert" type="button">
