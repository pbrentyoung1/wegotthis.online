                    ...
                    <div class="hs-dropdown [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--adaptive:adaptive] md:[--is-collapse:false] md:[--strategy:fixed]">
                        ...
                        <div aria-labelledby="topnav-main" aria-orientation="vertical"
                            ...
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                <button class="hs-dropdown-toggle dropdown-item w-full text-start flex items-center justify-between" id="topnav-submenu-dashboards" type="button">
                                    <span data-lang="dashboards">Dashboards</span>
                                    <div class="menu-arrow"></div>
                                </button>
                                <div aria-labelledby="topnav-submenu-dashboards" aria-orientation="vertical"
                                    ...
                                    role="menu">
                                    <a class="dropdown-item" href="{{ url("/dashboard/ecommerce") }}"><span data-lang="dashboard-ecommerce">Ecommerce</span></a>
                ...
                <li class="nav-item">
                    <div class="hs-dropdown [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--adaptive:adaptive] md:[--is-collapse:false] md:[--strategy:fixed]">
                        <button aria-expanded="false" aria-haspopup="menu" aria-label="Dropdown" class="hs-dropdown-toggle nav-link" id="topnav-apps" type="button">
                            <span class="menu-icon"><i class="iconify tabler--apps text-lg"></i></span>
                            <span class="menu-text" data-lang="apps">Apps</span>
                            <div class="menu-arrow"></div>
                        </button>
                        <div aria-labelledby="topnav-apps" aria-orientation="vertical"
                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative top-full z-10 hidden w-full ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:start-0 before:-top-4 before:h-5 before:w-full after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:w-52 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:after:hidden dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                            role="menu">
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                ...
                                <div aria-labelledby="topnav-submenu-ecommerce" aria-orientation="vertical"
                                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                    role="menu">
                                    <a class="dropdown-item" href="{{ url("/apps/ecommerce/marketplace") }}"><span data-lang="apps-ecommerce-marketplace">Marketplace</span></a>
                                    <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                        ...
                                        <div aria-labelledby="topnav-submenu-products" aria-orientation="vertical"
                                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                            role="menu">
                                    ...
                                    <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                        ...
                                        <div aria-labelledby="topnav-submenu-orders" aria-orientation="vertical"
                                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                            role="menu">
                                    ...
                                    <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                        ...
                                        <div aria-labelledby="topnav-submenu-sellers" aria-orientation="vertical"
                                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                            role="menu">
                                    ...
                                    <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                        ...
                                        <div aria-labelledby="topnav-submenu-inventory" aria-orientation="vertical"
                                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                            role="menu">
                                    ...
                                    <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                        ...
                                        <div aria-labelledby="topnav-submenu-reports" aria-orientation="vertical"
                                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                            role="menu">
                            ...
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                <button class="hs-dropdown-toggle dropdown-item w-full text-start flex items-center justify-between" id="topnav-submenu-email" type="button"><span data-lang="email">Email</span><span class="badge bg-danger text-white">New</span></button>
                                <div aria-labelledby="topnav-submenu-email" aria-orientation="vertical"
                                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                    role="menu">
                            ...
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                ...
                                <div aria-labelledby="topnav-submenu-users" aria-orientation="vertical"
                                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                    role="menu">
                            ...
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                ...
                                <div aria-labelledby="topnav-submenu-projects" aria-orientation="vertical"
                                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                    role="menu">
                            ...
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                ...
                                <div aria-labelledby="topnav-submenu-invoice" aria-orientation="vertical"
                                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                    role="menu">
                            ...
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                ...
                                <div aria-labelledby="topnav-submenu-more-apps" aria-orientation="vertical"
                                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                    role="menu">
                                    ...
                                    <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                        ...
                                        <div aria-labelledby="topnav-submenu-blog" aria-orientation="vertical"
                                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                            role="menu">
                                    ...
                                    <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                        ...
                                        <div aria-labelledby="topnav-submenu-forum" aria-orientation="vertical"
                                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                            role="menu">
                    ...
                    <div class="hs-dropdown [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--adaptive:adaptive] md:[--is-collapse:false] md:[--strategy:fixed]">
                        ...
                        <div aria-labelledby="topnav-custom-pages" aria-orientation="vertical"
                            ...
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                ...
                                <div aria-labelledby="topnav-submenu-pages" aria-orientation="vertical"
                                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                    role="menu">
                                    <a class="dropdown-item" href="{{ url("/pages/profile") }}"><span data-lang="pages-profile">Profile</span></a>
                                    <a class="dropdown-item" href="{{ url("/pages/account-settings") }}"><span data-lang="pages-account-settings">Account Settings</span></a>
                            ...
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                ...
                                <div aria-labelledby="topnav-submenu-plugins" aria-orientation="vertical"
                                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                    role="menu">
                                    <a class="dropdown-item" href="{{ url("/plugins/sortable") }}"><span data-lang="plugins-sortable">Sortable List</span></a>
                                    <a class="dropdown-item" href="{{ url("/plugins/text-diff") }}"><span data-lang="plugins-text-diff">Text Diff</span></a>
                                    ...
                                    <a class="dropdown-item" href="{{ url("/plugins/live-favicon") }}"><span data-lang="plugins-live-favicon">Live Favicon</span></a>
                                    ...
                                    <a class="dropdown-item" href="{{ url("/plugins/loading-buttons") }}"><span data-lang="plugins-loading-buttons">Loading Buttons</span></a>
                    ...
                    <div class="hs-dropdown [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--adaptive:adaptive] md:[--is-collapse:false] md:[--strategy:fixed]">
                        ...
                        <div aria-labelledby="topnav-components" aria-orientation="vertical"
                            ...
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                ...
                                <div aria-labelledby="topnav-submenu-base-ui" aria-orientation="vertical"
                                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                    role="menu">
                            ...
                            <a class="dropdown-item" href="widgets.html"><span data-lang="widgets">Widgets</span></a>
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                ...
                                <div aria-labelledby="topnav-submenu-charts" aria-orientation="vertical"
                                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                    role="menu">
                                    <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                        ...
                                        <div aria-labelledby="topnav-submenu-apex-charts" aria-orientation="vertical"
                                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                            role="menu">
                                    ...
                                    <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                        ...
                                        <div aria-labelledby="topnav-submenu-echarts" aria-orientation="vertical"
                                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                            role="menu">
                            ...
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                ...
                                <div aria-labelledby="topnav-submenu-forms" aria-orientation="vertical"
                                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                    role="menu">
                            ...
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                ...
                                <div aria-labelledby="topnav-submenu-tables" aria-orientation="vertical"
                                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                    role="menu">
                                    ...
                                    <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                        ...
                                        <div aria-labelledby="topnav-submenu-datatables" aria-orientation="vertical"
                                            class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                            role="menu">
                            ...
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                ...
                                <div aria-labelledby="topnav-submenu-icons" aria-orientation="vertical"
                                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                    role="menu">
                            ...
                            <div class="hs-dropdown relative [--adaptive:none] [--is-collapse:true] [--strategy:static] md:[--is-collapse:false] md:[--strategy:absolute] md:[--trigger:hover]">
                                ...
                                <div aria-labelledby="topnav-submenu-maps" aria-orientation="vertical"
                                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 relative z-10 hidden ps-7 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:hidden before:h-full before:w-5 after:absolute after:start-2 after:top-1 after:h-[calc(100%-4px)] after:w-0.5 after:bg-gray-100 md:end-full md:top-0 md:mx-2.5! md:mt-2 md:w-48 md:rounded-lg md:bg-white md:ps-1 md:shadow-md md:duration-[150ms] md:before:block md:after:hidden dark:divide-neutral-700 dark:bg-neutral-800 dark:after:bg-neutral-700 dark:md:bg-neutral-800"
                                    role="menu">
